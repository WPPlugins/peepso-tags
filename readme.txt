...
* Fix Unable to tag original poster in nested comments.

= 1.6.3 =
* Impr Compatibility with PeepSo 1.6.3.
* Impr Generated new .POT file.
* Impr Nested comments and replies - tagging speed improvements.

= 1.6.2 =
* New Automatically tag a user when replying in nested comments.
* Impr Compatibility with PeepSo 1.6.2.
* Impr Generated new .POT file.
* Impr Notification improvements when tagging someone in a comment.
* Fix Add comment in repost sends empty content.
...
= 1.6.0 =
* New Tagging users in comments sends notifications even if they haven't participated in the conversation. 
* New Add a setting to preferences about tag notifications in comments.
* Impr Generated new .POT file.
